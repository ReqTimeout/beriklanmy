...
SERVICES = [
    ...
    ('live-stream-viewers-tiktok', 'view live tiktok'),
    ('live-stream-viewers-tiktok', 'live streaming tiktok'),
    ('live-stream-viewers-tiktok', 'viewers tiktok'),
    ('jasa-shopee-affiliate', 'shopee affiliate'),
    ('jasa-shopee-affiliate', 'jualan shopee'),
    ('jasa-shopee-affiliate', 'shopee store'),
    ('jasa-lazada-affiliate', 'lazada affiliate'),
    ('jasa-lazada-affiliate', 'jualan lazada'),
]
