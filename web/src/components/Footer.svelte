<script>
    ...
    const services = [
        ...
        { label: 'Instagram Ads', href: '/instagram-ads-management' },
        { label: 'Google Search Ads', href: '/google-ads-management' },
        { label: 'TikTok Ads', href: '/tiktok-ads-management' },
        { label: 'YouTube Ads', href: '/youtube-ads-management' },
        { label: 'Buzzer Live', href: '/live-stream-viewers', highlight: true },
        { label: 'Landing Page', href: '/landing-page-design' },
    ];

    const live = [
        { label: 'TikTok Live', href: '/tiktok-live-viewers' },
        { label: 'Shopee Live', href: '/shopee-live-viewers' },
        { label: 'YouTube Live', href: '/youtube-live-viewers' },
        { label: 'Instagram Live', href: '/instagram-live-viewers' },
    ...
    <div class="container mx-auto px-6 relative">
        <div class="grid lg:grid-cols-2 gap-10 pb-12 border-b border-white/10">
            ...
            <div class="flex flex-col sm:flex-row lg:justify-end gap-3 items-start lg:items-center">
                ...
                <a href="mailto:info@beriklan.my" class="inline-flex items-center gap-2 border border-white/20 text-white font-semibold px-6 py-3 rounded-full hover:bg-white/5 transition">
                    info@beriklan.my
                </a>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-6 gap-8 py-12">
            <div class="md:col-span-1">
                ...
                <div class="flex gap-3 mt-5">
                    ...
                    <a href="https://facebook.com/beriklan.my" target="_blank" rel="noopener" aria-label="Facebook" class="w-9 h-9 rounded-full bg-white/5 hover:bg-accent hover:text-ink flex items-center justify-center transition">
